...
public class CharacterController2 : Component, INetworkSerializable
{
	[Range( 0, 200 )]
	...
	void CategorizePosition()
	{
		...
		//
		// hack: let the player ride the conveyor.
		//
		Log.Info( pm.Tags.Contains( "conveyor" ) );
		Components.Get<Rigidbody>(true).PhysicsBody.Enabled = pm.Tags.Contains( "conveyor" );
