...
public class PlayerController : Component, INetworkSerializable
{
	...
	protected override void OnUpdate()
	{
		...
		if ( !IsProxy )
		{
			...
			if ( FirstPerson )
			{
				Eye.Transform.Position = Eye.Transform.Position;
				Eye.Transform.Rotation = lookDir;
			}
			else
			{
				Eye.Transform.Position = Transform.Position + lookDir.Backward * 300 + Vector3.Up * 75.0f;
				Eye.Transform.Rotation = lookDir;
			}
		...
		var cc = GameObject.Components.Get<CharacterController2>();
